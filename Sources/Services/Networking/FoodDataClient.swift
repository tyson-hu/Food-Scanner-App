...
public protocol FoodDataClient: Sendable {
    ...
    func searchFoodsWithPagination(matching query: String, page: Int, pageSize: Int) async throws
        -> FoodDataSearchResult
...
public struct FoodDataSearchResult: Sendable, Codable, Equatable {
...
enum FoodDataError: LocalizedError {
    case invalidURL
